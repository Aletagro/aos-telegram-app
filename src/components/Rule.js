...
const Rule = ({rule}) => {
    ...
    switch (rule.contentType) {
        case 'text':
            return <p id='text' key={rule.id}>{replaceAsterisks(rule.textContent)}</p>
        case 'header':
        case 'textBold':
            return <p id='textBold' key={rule.id}>{replaceAsterisks(rule.textContent)}</p>
        case 'textItalic':
            return <p id='textItalic' key={rule.id}>{replaceAsterisks(rule.textContent)}</p>
        case 'boxedText':
            return <p id='lightgreyContainer' key={rule.id}>{replaceAsterisks(rule.textContent)}</p>
        case 'accordion':
